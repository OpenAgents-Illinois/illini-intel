...
export type AgentEvent =
  ...
  | { type: "team_header"; illinois_rank: number | null; illinois_name: string; illinois_mascot: string; opponent_name: string; opponent_mascot: string; opponent_rank: number | null; game_context: string }
